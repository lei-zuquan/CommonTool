package com.java.algorithm.linear;
...
越明显
    ...
    为什么Java源码中有ArrayList.java 顺序链表，我们还需要自己编写定义顺序链表呢？
        1、因为ArrayList.java 设计时是为了其通用性，所以多了很多判断、异常处理，代码行数1468行
